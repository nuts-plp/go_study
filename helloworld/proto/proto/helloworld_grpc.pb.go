...
const (
	...
	Helloworld_Stream_FullMethodName   = "/helloworld.Helloworld/Stream"
	Helloworld_PingPong_FullMethodName = "/helloworld.Helloworld/PingPong"
)
...
func (c *helloworldClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, Helloworld_Call_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloworldClient) Stream(ctx context.Context, in *StreamingRequest, opts ...grpc.CallOption) (Helloworld_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Helloworld_ServiceDesc.Streams[0], Helloworld_Stream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloworldClient) PingPong(ctx context.Context, opts ...grpc.CallOption) (Helloworld_PingPongClient, error) {
	stream, err := c.cc.NewStream(ctx, &Helloworld_ServiceDesc.Streams[1], Helloworld_PingPong_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
